    ...
    <div class="highlights-wrapper">
      <div class="highlight">
        <div class="card">
          ...
          <div class="card-info">
            <div class="card-justify">
              <div class="info-main">
                <div class="info-main-num">{{ info?.wind?.speed }}</div>
                <div class="info-main-text">m/s</div>
              </div>
              <div class="info-main">
                <div class="info-main-num">{{ info?.wind?.deg }}</div>
        ...
        <div class="card-small">
          ...
          <div class="card-small-info">
            <div class="card-small-data" v-if="info?.wind?.gust">
              <div class="info-main-num">
                {{ Math.round(info?.wind?.gust) }}
              </div>
              <div class="info-main-text">m/s</div>
            </div>
        ...
        <div class="card">
          ...
          <div class="card-info">
            <div class="card-centered">
              <div class="info-main">
                <div class="info-main-num">
                  {{ getPressureMm(info?.main?.pressure) }}
                </div>
        ...
        <div class="card-small">
          ...
          <div class="card-small-info">
            <div class="card-small-data">
              <div class="info-main-num">{{Math.round(info?.main?.feels_like)}}</div>
      ...
      <div class="highlight">
        ...
        <div class="card-small">
          ...
          <div class="card-small-info">
            <div class="card-small-data" v-if="info.clouds.all">
              <div class="info-main-num">{{info?.clouds?.all}}</div>
...
const timeZone=computed(()=>{
    return props.info?.timezone 
})
const sunriseTime=computed(()=>{
return getTime(props.info?.sys?.sunrise+timeZone.value)
})
const sunsetTime=computed(()=>{
return getTime(props.info?.sys?.sunset+timeZone.value)
})
